/*
 ...
 Source Server         : aionclassiceu
 Source Server Type    : MySQL
 Source Server Version : 50546 (5.5.46)
 Source Host           : localhost:3306
 Source Schema         : aionclassiceu
...
CREATE TABLE `account_blackcloud`  (
  ...
  CONSTRAINT `FK__account_data` FOREIGN KEY (`owner`) REFERENCES `account_data` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `account_data`  (
  ...
  `reward_points` int(15) NULL DEFAULT 0,
...
-- ----------------------------
DROP TABLE IF EXISTS `account_locale`;
CREATE TABLE `account_locale`  (
  `account_id` int(11) NOT NULL,
  `locale` varchar(2) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `audit`  (
  ...
  `type` enum('cmd') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `blackcloud_item`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `blackcloud_id`(`blackcloud_id`) USING BTREE,
  CONSTRAINT `FK__account_blackcloud` FOREIGN KEY (`blackcloud_id`) REFERENCES `account_blackcloud` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `cms_reward`  (
  ...
  `rewarded` tinyint(1) NOT NULL DEFAULT 0,
  `added` varchar(70) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `received` varchar(70) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  PRIMARY KEY (`unique`) USING BTREE,
  INDEX `item_owner`(`item_owner`) USING BTREE,
  CONSTRAINT `cms_reward_ibfk_1` FOREIGN KEY (`item_owner`) REFERENCES `players` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `command`  (
  ...
  `help` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  PRIMARY KEY (`name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for command_alias
-- ----------------------------
DROP TABLE IF EXISTS `command_alias`;
CREATE TABLE `command_alias`  (
  `alias` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `name` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
-- ----------------------------
-- Table structure for customrank
-- ----------------------------
DROP TABLE IF EXISTS `customrank`;
CREATE TABLE `customrank`  (
  `rank` int(11) NOT NULL,
  `pts` int(11) NOT NULL,
  `playerObjId` int(11) NOT NULL,
  PRIMARY KEY (`playerObjId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `inventory`  (
  ...
  `color_expires` int(11) NULL DEFAULT NULL,
  `item_owner` int(11) NOT NULL,
  `item_creator` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `item`  (
  ...
  `createur` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `legion_join_requests`  (
  ...
  `playerName` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  ...
  `joinRequestMsg` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `legions`  (
  ...
  `joinType` int(1) NULL DEFAULT 0,
  `minJoinLevel` int(3) NULL DEFAULT 0,
  `mainActivity` int(3) NULL DEFAULT 0,
  `growthLevel` int(11) NULL DEFAULT 1,
  `growthExp` bigint(20) NULL DEFAULT 0,
  `essenceCoin` bigint(20) NULL DEFAULT 0,
  `essenceFragment` bigint(20) NULL DEFAULT 0,
  `productivityStep` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `mail`  (
  ...
  `attached_item_count` int(11) NULL DEFAULT 1,
...
CREATE TABLE `players`  (
  ...
  `player_class` enum('WARRIOR','GLADIATOR','TEMPLAR','SCOUT','ASSASSIN','RANGER','MAGE','SORCERER','SPIRIT_MASTER','PRIEST','CLERIC','CHANTER','MONK','THUNDERER') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `wardrobe_size` int(11) NULL DEFAULT 1,
  `frenzy_points` int(4) NULL DEFAULT 0,
  `frenzy_count` int(1) NULL DEFAULT 0,
  `join_legion_id` int(11) NULL DEFAULT 0,
  `join_state` enum('NONE','DENIED','ACCEPTED') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'NONE',
  `guildCoins` int(11) NULL DEFAULT 0,
  `unstuck` bigint(20) NOT NULL,
  `gmconfig` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name_unique`(`name`) USING BTREE,
  INDEX `account_id`(`account_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `siege_locations`  (
  ...
  PRIMARY KEY (`id`, `occupy_count`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `siege_spawns`  (
  ...
  `race` enum('ELYOS','ASMODIANS','BALAUR') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `protector` int(10) NULL DEFAULT 0,
  `stype` enum('PEACE','GUARD','ARTIFACT','PROTECTOR','MINE','PORTAL','GENERATOR','SPRING','RACEPROTECTOR','UNDERPASS') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `skill_motions`  (
  ...
  `time` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`motion_name`, `skill_id`, `attack_speed`, `weapon_type`, `off_weapon_type`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `spawns`  (
  ...
  `npc_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `map_id` int(10) NOT NULL,
  `pool_size` int(5) NOT NULL DEFAULT 1,
  `anchor` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `handler` enum('RIFT','STATIC') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `spawn_time` enum('ALL','DAY','NIGHT') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'ALL',
  `walker_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `author` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'system',
  PRIMARY KEY (`spawn_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
-- ----------------------------
DROP TABLE IF EXISTS `spawns_loc`;
CREATE TABLE `spawns_loc`  (
  `spawn_id` int(10) NOT NULL,
  `x` float NOT NULL,
  `y` float NOT NULL,
  `z` float NOT NULL,
  `heading` tinyint(3) NOT NULL,
  INDEX `fk_sp_id`(`spawn_id`) USING BTREE,
...
CREATE TABLE `vote`  (
  ...
  PRIMARY KEY (`idvote`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `web_shop`  (
  ...
  PRIMARY KEY (`unique`) USING BTREE,
  INDEX `item_owner`(`item_owner`) USING BTREE,
  INDEX `web_shop_ibfk_1`(`item_count`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `weddings`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `player1`(`player1`) USING BTREE,
  INDEX `player2`(`player2`) USING BTREE,
