...
public class CmdAddSkill extends AbstractGMHandler {
    ...
    private void run() {
        ...
        //SkillTemplate template = DataManager.SKILL_DATA.getSkillTemplate(params.toUpperCase().trim());
        //if (template!= null) {
        ...
        //    t.getSkillList().addSkill(t, template.getSkillId(), 1);//è¿™é‡Œé£Žæš´å�¯ä»¥ä¼˜åŒ–
        //}
    }
}
