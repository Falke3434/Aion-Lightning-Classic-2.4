...
public enum AttackStatus {
	DODGE(0, true, false), OFFHAND_DODGE(1, true, false), PARRY(2, true, false), OFFHAND_PARRY(3, true, false), BLOCK(4,
			true, false), OFFHAND_BLOCK(5, true, false), RESIST(6), OFFHAND_RESIST(7), BUF(8), // ??
	OFFHAND_BUF(9), NORMALHIT(10), OFFHAND_NORMALHIT(11), CRITICAL_DODGE(-64, true, true), CRITICAL_PARRY(-624, true,
			true), CRITICAL_BLOCK(-604, true, true), PHYSICAL_CRITICAL_RESIST(-58, false, true), CRITICAL(-54, false,
					true), OFFHAND_CRITICAL_DODGE(-474, true, true), OFFHAND_CRITICAL_PARRY(-454, true,
							true), OFFHAND_CRITICAL_BLOCK(-434, true, true), OFFHAND_CRITICAL_RESIST(-41, false,
									true), OFFHAND_CRITICAL(-37, false, true);
