...
public class FortressSiegeStartRunnable implements Runnable {
	...
	/*
	 * private SiegeNpc getProtector() { Collection<SiegeNpc> npcs =
	 * World.getInstance().getLocalSiegeNpcs(getFortressSiegeLocationId()); for
	 * (SiegeNpc npc : npcs) { if
	 * (SIEGE_BOSS_AI_NAME.equals(npc.getObjectTemplate().getAi())) return npc; }
	 * throw new SiegeException("Not Found Protector for assault: " +
	 * getFortressSiegeLocationId()); }
	 */
