...
abstract class DataLoader {
	 ...
	 * 
	 * @param file
	 *            file or directory in the static data directory, containing data
	 *            that will be loaded
	 */
	 ...
	 *            with "#" sign.<br>
	 *            Every read row is then forwarded to {@link #parse(String)} method,
	 *            which should be overriden in subclcass.
	 */
	 ...
	 * 
	 * @param dataEntry
	 *            A String containing data about a data entry, that is to be parsed
	 *            by this method.
	 */
