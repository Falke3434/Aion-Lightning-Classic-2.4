...
public class GameServerInfo {
	...
	/**
	 * Returns active GsConnection for this GameServer or null if this GameServer is
	 * down.
	 * 
	 * @return GsConnection
	 */
	 ...
	 * The problem is that players can access server from various subnetworks so we
	 * need to send different ip adresses.<br>
