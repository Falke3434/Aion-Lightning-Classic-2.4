...
public class LoginConnection extends AConnection {
	...
	/**
	 * Account object for this connection. if state = AUTHED_LOGIN account cant be
	 * null.
	 */
	...
	/**
	 * This method should no be modified, hashcode in this class is used to ensure
	 * that each connection hash unique id
	 *
