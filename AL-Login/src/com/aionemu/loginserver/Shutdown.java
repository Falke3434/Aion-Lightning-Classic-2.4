...
public class Shutdown extends Thread {
	 ...
	 * thread of getInstance, then this is the shutdown hook and we save all data
	 * and disconnect all clients. after this thread ends, the server will
	 * completely exit if this is not the thread of getInstance, then this is a
	 * countdown thread. we start the countdown, and when we finished it, and it was
	 * not aborted, we tell the shutdown-hook why we call exit, and then call exit
